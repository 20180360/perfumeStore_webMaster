...
import perfumeOne from '../../assets/images/pink.webp'
import perfumeTwo from '../../assets/images/red.webp'
import perfumeThree from '../../assets/images/chanel.jpeg'
import perfumeFour from '../../assets/images/goodgirlred.jpeg'
import perfumeFive from '../../assets/images/product-item-16.jpg'
import { ShoppingCartIcon } from 'lucide-react'
import { useProductActions } from '../../hooks/useProductActions';
const products = [
  { image: perfumeOne, id:85, name: 'Amber Bloom', price: '$59.99', rating: 4.5 },
  { image: perfumeTwo,id:86, name: 'Ocean Mist', price: '$69.99', rating: 4 },
  { image:perfumeThree,id:87, name: 'Rose Noir', price: '$49.99', rating: 5 },
  { image: perfumeFour,id:88, name: 'Citrus Rush', price: '$39.99', rating: 3.5 },
  { image: perfumeFive,id:89, name: 'Mystic Oud', price: '$89.99', rating: 4.8 },
]
    ...
    >
      ...
      <div className="relative w-[220px] h-[300px] mx-auto">
        <img
          src={product.image}
          alt={product.name}
          className="w-[220px] h-[300px] object-cover rounded-t-2xl"
        />
